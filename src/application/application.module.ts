...
import { TryAgainQuestions } from '@application/questions/try-again.question';
...
@Module({
  ...
  providers: [TypeQuestions, CustomDatasetQuestion, TryAgainQuestions, FrequencyRunner, ReadDatasetService, FrequencyService]
})
